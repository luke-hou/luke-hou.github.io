...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function getProjectDetails(projectId) {
        ...
        const projects = {
            ...
            'n8n-2': {
                title: 'n8n 教學 (二)：第一個 Workflow 實作',
            ...
            'n8n-6': {
                title: 'n8n 教學 (六)：HTTP 請求與 API 整合',
                image: 'images/project2-thumbnail.jpg',
                tech: 'n8n, API',
